...
const Footer = () => {
  return (
    <footer className=" bg-bgDark text-white">
      <main className=" p-[16px] flex flex-col justify-center items-center">
        <section className="sm:flex sm:flex-wrap p-[64px] lg:gap-[164px]">
          ...
          <div className=" flex justify-around  gap-[64px] md:order-last md:gap-0 lg:order-none lg:gap-[164px] sm:mt-[32px] py-[24px] md:mt-0 lg:py-0">
          ...
          <div className="w-[328px] lg:w-[302px]">
