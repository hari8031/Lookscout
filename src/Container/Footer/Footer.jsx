  ...
  return (
    <footer className=" bg-bgDark text-white ">
      <main className="flex flex-col justify-center items-center">
        <section >
          <div className="sm:flex sm:flex-wrap px-[16px] md:p-[64px] lg:gap-[164px]">
          ...
          <section className="flex mx-[64px] md:pb-[40px] pb-[24px] justify-between  border-t-[1px] md:flex-row flex-col mt-[24px] md:mt-[48px ] border-gray-700">
            <h5 className=" text-pTextLightColor mt-[24px]">
              © 2023 Lookscout. All Rights Reserved.
            </h5>
            <div className="flex justify-around md:gap-3 mt-[24px]">
